...
export default function Applications() {
    ...
    useEffect(() => {
        ...
        async function fetchUserApplicationsList() {
            const userApplications = await ApplicationDatabaseService.fetchUserApplications(user.id);
            setApplicationsList(Array.isArray(userApplications) ? userApplications : []);
        }
