...
export default function PersonalDetails() {
  ...
  async function updateUserInformation() {
    ...
    if (typeof result !== 'object') {
      createAlert({ title: 'Update Personal Information', text: result })
      return;
    }

    result.preferences = await AsyncStorageService.getOrSetUserPreferences();
    AsyncStorageService.convertImageBase64ToUri(result)
