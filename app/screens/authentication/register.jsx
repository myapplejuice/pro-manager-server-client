...
import { prefetchMainScreens } from '../../utils/services/screens-prefetch';
...
export default function Register() {
    ...
    async function initSignUp() {
        ...
        try {
            ...
            const data = await UserDatabaseService.insertUser(username, firstname, lastname, Number(age), gender, email, phone, password, isCoach, imageBase64);
            if (typeof data === "object") {
                createAlert({
                    title: "Registration",
                    text: `Registration success!\nClick OK to continue`,
                    onPress: async () => {
                        const finalizedData = await AsyncStorageService.signInUser(data)
